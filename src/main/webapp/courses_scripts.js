...
function displayCoursesTeacher() {
	...
	xhr.open('GET', 'http://' + window.location.host + '/my-first-webapp-1.0-SNAPSHOT/courses_teacher', true);
	xhr.send(null);
}
...
function displayCoursesStudent() {
	...
	xhr.open('GET', 'http://' + window.location.host + '/my-first-webapp-1.0-SNAPSHOT/courses_student', true);
	xhr.send(null);
}
